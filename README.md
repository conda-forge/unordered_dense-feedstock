About unordered_dense-feedstock
===============================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/unordered_dense-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/unordered_dense-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add unordered_dense
# for installing globally
pixi global install unordered_dense
```
...
It is possible to list all of the versions of `unordered_dense` available on your platform:
...
```
pixi search unordered_dense --channel conda-forge
```
